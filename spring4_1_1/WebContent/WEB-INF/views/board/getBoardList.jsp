...
<script type="text/javascript" defer src="<%=path.toString()  %>js/jquery.easyui.min.js"></script>   
...
%>
            <a href="download.jsp?bs_file=<%=rmap.get("BS_FILE")%>" style="text-decoration:none;"><%=rmap.get("BS_FILE") %></td>
<%
	}
%>
